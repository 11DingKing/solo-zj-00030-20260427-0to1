      ...
      {loading ? (
        ...
        <div className="card" style={{ padding: '3rem', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--gray-500)' }}>
            {filter === 'unread' ? '您的所有通知都已阅读' : '当有新消息时会在这里显示'}
          </p>
        </div>
      ) : (
        <div className="card">
            ...
            {filteredNotifications.map((notification) => (
              <div
                ...
                style={{
                  ...
                  background: notification.is_read ? 'var(--white)' : 'rgba(59, 130, 246, 0.03)',
                  display: 'flex',
                  justifyContent: 'space-between',
                ...
                <div style={{ display: 'flex', gap: '1rem', flex: 1 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                      ...
                      <h4 style={{ fontWeight: notification.is_read ? 500 : 600 }}>
                        {notification.title}
                      </h4>
                      <span className={`badge ${getTypeBadgeClass(notification.type)}`} style={{ fontSize: '0.65rem' }}>
      ...
      <div className="card" style={{ marginTop: '1.5rem' }}>
        ...
        <div className="card-body">
          <div className="grid grid-cols-2 gap-4" style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
            <div style={{ padding: '1rem', background: 'var(--gray-50)', borderRadius: 'var(--border-radius)' }}>
